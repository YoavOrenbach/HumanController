...
def load_movenet_model(model_name):
    if "tflite" in model_name:
        if "movenet_lightning" in model_name:
            tflite_path = "movenet_models/lite-model_movenet_singlepose_lightning_tflite_float16_4.tflite"
            input_size = 192
        elif "movenet_thunder" in model_name:
            tflite_path = "movenet_models/lite-model_movenet_singlepose_thunder_tflite_float16_4.tflite"
            input_size = 256
        else:
        ...
        if "movenet_lightning" in model_name:
            module = hub.load("movenet_models/movenet_singlepose_lightning_4")
            input_size = 192
        elif "movenet_thunder" in model_name:
            module = hub.load("movenet_models/movenet_singlepose_thunder_4")
            input_size = 256
        else:
            raise ValueError("Unsupported model name: %s" % model_name)
...
def feature_engineering(landmarks):
    ...
    embedding = distance_embedding(landmarks)
    return embedding
