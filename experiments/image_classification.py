...
def preprocess_data(data_dir="dataset"):
...
def mobilenet_preprocess_data(data_directory="dataset"):
    dataset = tf.keras.utils.image_dataset_from_directory(data_directory, image_size=IMG_SIZE, batch_size=BATCH_SIZE)
...
def image_classification_model(model_name="mobilenet"):
